...
class GPTNeoXAttention(nn.Module):
    ...
    def _attn(
        ...
        y = xops.memory_efficient_attention(query.transpose(1, 2), key.transpose(1, 2), value.transpose(1, 2), p=0.0, attn_bias=xops.LowerTriangularMask(), scale=self.scale_attn).to(torch.float16)
        return y, None
